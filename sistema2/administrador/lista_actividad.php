...
<main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="app-menu__icon fa fa-user-graduate"></i> Lista de Actividades
          <button class="btn btn-success" type="button" onclick="openModal_act()">Nueva Actividad</button></h1>
        </div>
