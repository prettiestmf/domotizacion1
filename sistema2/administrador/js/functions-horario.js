...
document.addEventListener('DOMContentLoaded',function(){
    ...
    formHorario.onsubmit = function(e) {
        ...
        var aula = document.querySelector('#hora_on').value;
        var aula = document.querySelector('#hora_off').value;
        var aula = document.querySelector('#dia').value;
        ...
        request.onreadystatechange = function() {
            if(request.readyState == 4 && request.status == 200) {
                ...
                if(data.status) {
                    ...
                    document.querySelector('#hora_on').value = data.data.hora_om;
